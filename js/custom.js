...
　 }
    ...
    $contactForm.submit(function(){
        var $success      = '<strong>¡Exito!</strong> Tu mensaje fue enviado..';
	    var $error      = '<strong>¡Error!</strong>  Su mensaje no se ha enviado, intentelo más tarde...';
      	var response;
        if ($contactForm.valid()){
            $.ajax({
                type: "POST",
                url: "https://formspree.io/jrivas@jr.co.ve",
                data: $(this).serialize(),
                dataType: "json",
